...
text_en = ({
    "start" : 
"""Greetings! I am your personal shopping assistant, here to make your online shopping experience a breeze!  

Simply type /help to discover all the ways I can assist you in finding the perfect items for your needs.""",
    "start_description" : "A wellcome message if you dont known this bot",
    "help" : 

"""Get started by registering your account password with me using the command /register.(You must have a username to register) Once you're registered, you'll have access to a plethora of amazing products, categorized by type. Use the command /show_categories to browse through our wide selection of products and find exactly what you're looking for.

If you're looking for a specific product, simply use the command /search to quickly find it.
...
""",
    ...
    "this_is_not_a_valid_category": "This category does not exist.",
